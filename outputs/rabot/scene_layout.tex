% Auto-generated TikZ wrapper for scene_layout.png
...
\begin{tikzpicture}
  \node[anchor=south west, inner sep=0] at (0,0) {\includegraphics[width=\postprocessfigurewidth]{scene_layout.png}};
\end{tikzpicture}
