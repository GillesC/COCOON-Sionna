% Auto-generated TikZ wrapper for users_below_threshold_timeseries.png
...
\begin{tikzpicture}
  \node[anchor=south west, inner sep=0] at (0,0) {\includegraphics[width=\postprocessfigurewidth]{users_below_threshold_timeseries.png}};
\end{tikzpicture}
