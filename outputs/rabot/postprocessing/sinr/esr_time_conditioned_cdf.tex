% Auto-generated TikZ wrapper for esr_time_conditioned_cdf.png
...
\begin{tikzpicture}
  \node[anchor=south west, inner sep=0] at (0,0) {\includegraphics[width=\postprocessfigurewidth]{esr_time_conditioned_cdf.png}};
\end{tikzpicture}
