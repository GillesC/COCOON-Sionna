% Auto-generated TikZ wrapper for sinr_threshold_sweep.png
...
\begin{tikzpicture}
  \node[anchor=south west, inner sep=0] at (0,0) {\includegraphics[width=\postprocessfigurewidth]{sinr_threshold_sweep.png}};
\end{tikzpicture}
