% Auto-generated TikZ wrapper for worst_user_sinr_timeseries.png
...
\begin{tikzpicture}
  \node[anchor=south west, inner sep=0] at (0,0) {\includegraphics[width=\postprocessfigurewidth]{worst_user_sinr_timeseries.png}};
\end{tikzpicture}
