...
\begin{itemize}
    ...
    \item The present draft is figure-structured but interpretation-light by design; the reported placeholders must be refreshed after rerunning the pipeline.
